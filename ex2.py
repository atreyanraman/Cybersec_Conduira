...
def mynetwork():
    ...
    switch0.cmd('ovs-ofctl dp0 \"in_port=1 actions=output:2\"')
    switch0.cmd('ovs-ofctl dp0 \"in_port=2 actions=output:1\"')
    switch1.cmd('ovs-ofctl dp1 \"in_port=2 actions=output:2\"')
    switch1.cmd('ovs-ofctl dp1 \"in_port=1 actions=output:1\"')
